...
class Nanoc::XSLT::FilterTest < Minitest::Test
...
EOS
  ...
  def test_filter_as_layout
    ...
    filter = ::Nanoc::XSLT::Filter.new(:layout => layout)
    result = filter.run(self.sample_xml_in)
  ...
  def test_filter_with_params
    ...
    filter = ::Nanoc::XSLT::Filter.new(:layout => layout)
    result = filter.run(self.sample_xml_in_with_params, :foo => 'bar')
